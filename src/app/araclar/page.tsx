...
export const metadata: Metadata = {
  title:
    "Donanım Araçları ve Hesaplayıcılar",

  description:
    "PC toplama, darboğaz, FPS, PSU watt, indirme süresi ve dönüştürme araçlarını ücretsiz kullanın.",
  ...
  openGraph: {
    ...
    description:
      "PC toplama, performans analizi, FPS, darboğaz ve PSU hesaplama araçları.",
  },
...
const tools = [
  {
    ...
    description:
      "Bütçene ve kullanım amacına göre optimize edilmiş sistemleri otomatik oluştur.",
  ...
  },
  {
    ...
    description:
      "Parçaları birleştirin, uyumluluğu ve toplam fiyatı test edin.",
  ...
  },
  {
    ...
    description:
      "İşlemci ve ekran kartı arasındaki darboğaz oranını hesaplayın.",
  ...
  },
  {
    ...
    description:
      "Donanımınızın oyunlarda vereceği tahmini FPS değerlerini görün.",
    href: "/araclar/fps",
    icon: Gamepad2,
  },
  {
    ...
    description:
      "Sisteminiz için gereken güç kaynağı değerini hesaplayın.",
    href: "/araclar/psu",
    icon: Zap,
  },
  {
    ...
    description:
      "İnternet hızınıza göre oyun indirme süresini hesaplayın.",
    href: "/araclar/steam",
    icon: Download,
  },
  {
    ...
    description:
      "Depolama ve frekans birimlerini birbirine dönüştürün.",
    href: "/araclar/birim",
    icon: RefreshCw,
  },
  {
    ...
    description:
      "Görsellerinizi farklı formatlara anında dönüştürün.",
    href: "/araclar/resim",
    icon: ImageIcon,
  },
  {
    ...
    description:
      "Notlarınızı ve metin belgelerinizi farklı formatlara aktarın.",
    href: "/araclar/belge",
    icon: FileText,
  },
];
    ...
    <div className="max-w-7xl mx-auto px-6 py-8 flex flex-col gap-8">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-zinc-400 text-sm">
          Sistem toplama, performans testi ve dönüştürme araçlarına buradan ulaşın.
        </p>
      </div>
