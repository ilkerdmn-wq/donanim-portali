...
export default function NewLaptopComparisonPage() {
  const [
    document,
    setDocument,
  ] =
  ...
  const save = async () => {
    ...
    try {
      ...
      setMessage(
        data.document
          .published
          ? "Karşılaştırma oluşturuldu ve yayınlandı."
          : "Karşılaştırma taslak olarak oluşturuldu."
      );
    } catch (error) {
      setErrorMessage(
        error instanceof Error
    ...
    <main className="min-h-screen bg-zinc-950 px-4 py-10 text-white">
      <div className="mx-auto max-w-7xl">
        ...
        <section className="mt-8 rounded-2xl border border-zinc-800 bg-zinc-900/40 p-5">
          ...
          <div className="mt-5 grid grid-cols-1 gap-5 lg:grid-cols-2">
            <label className="text-xs font-bold text-zinc-300">
              ...
              <input
                ...
                placeholder="Örn. Acer Nitro V 15 vs Lenovo LOQ"
              />
            </label>
            ...
            <label className="text-xs font-bold text-zinc-300">
              ...
              <input
                ...
                className={`mt-2 ${input}`}
                placeholder="acer-nitro-v-15-vs-lenovo-loq"
              />
          ...
          <label className="mt-5 block text-xs font-bold text-zinc-300">
            ...
            <textarea
              ...
              placeholder="Karşılaştırma liste kartında gösterilecek kısa açıklama."
            />
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {document.columns
              ...
              <button
                ...
                className="rounded-xl border border-zinc-700 px-4 py-2.5 text-xs font-bold text-rose-300 transition-colors hover:border-rose-400/50"
              >
                Üçüncü sütunu
                kaldır
              </button>
                  ...
                  (column) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <label className="cursor-pointer rounded-lg border border-zinc-700 px-3 py-2 text-xs font-bold text-cyan-300 transition-colors hover:border-cyan-400">
                          {uploading ===
                          column.id
                            ? "Yükleniyor..."
                            : "Görsel yükle"}
                      ...
                      {column.imageUrl && (
                        <button
                          ...
                          className="mt-2 text-xs text-zinc-500 transition-colors hover:text-rose-300"
                        >
                          Görseli
                          kaldır
                        </button>
                    ...
                    <td className="border-r border-zinc-800 p-2">
                      <div className="flex items-center gap-1">
                        ...
                        <button
                          ...
                          className="p-1 text-zinc-600 transition-colors hover:text-rose-300"
                        >
                          <Trash2
                            size={
                              14
                        ...
                        >
                          <div className="flex items-center gap-2">
                            <input
                              ...
                              placeholder="Değeri yaz"
                            />

                            <label
                              title="Kâğıt üzerinde üstün göster"
                              className="flex shrink-0 items-center gap-1 text-xs text-zinc-400"
                            >
                              <input
                                type="checkbox"
                                checked={
                        ...
                        (() => {
                          ...
                          return (
                            <Link
                              ...
                              target="_blank"
                              className="mt-3 flex items-center gap-3 rounded-xl border border-zinc-800 bg-zinc-950/80 p-3 transition-colors hover:border-cyan-500/40"
                            >
                              <div className="flex h-16 w-24 shrink-0 items-center justify-center overflow-hidden rounded-lg border border-zinc-800 bg-white">
                                {selectedReview.image_url ? (
                                  ...
                                  <span className="px-2 text-center text-[10px] font-bold text-zinc-500">
                                    Görsel yok
                                  </span>
                                )}
                              </div>
                              ...
                              <div className="min-w-0 flex-1">
                                <span className="block text-[10px] font-black uppercase tracking-wide text-cyan-400">
                                  Bağlı inceleme
                                </span>
        ...
        <button
          type="button"
          onClick={addRow}
          className="mt-4 inline-flex items-center gap-2 rounded-xl border border-zinc-700 px-4 py-2.5 text-sm font-bold transition-colors hover:border-cyan-400"
        >
          <Plus size={16} />
          Özellik satırı
          ekle
        ...
        <div className="mt-8 flex flex-wrap items-center gap-4 rounded-2xl border border-zinc-800 bg-zinc-900/40 p-5">
          ...
          <button
            ...
            disabled={busy}
            onClick={save}
            className="inline-flex items-center gap-2 rounded-xl bg-cyan-400 px-5 py-3 text-sm font-black text-zinc-950 transition-colors hover:bg-cyan-300 disabled:opacity-50"
          >
            <Save size={16} />
        ...
        {message && (
          <p
            role="status"
            className="mt-4 rounded-xl border border-emerald-500/20 bg-emerald-500/5 px-4 py-3 text-sm text-emerald-300"
          >
            {message}
          </p>
        )}
        ...
        {errorMessage && (
          <p
            role="alert"
            className="mt-4 rounded-xl border border-rose-500/20 bg-rose-500/5 px-4 py-3 text-sm text-rose-300"
          >
            {errorMessage}
          </p>
        )}
