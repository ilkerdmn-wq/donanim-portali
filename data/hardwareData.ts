...
export const hardwareData: Record<string, HardwareItem[]> = {
  islemci: [
    {
      ...
      description:
        "AM5 soket yapısına sahip, yüksek performanslı yeni nesil işlemci.",
      specs: {
        Soket: "AM5",
        Çekirdek: "6",
        "İş Parçacığı": "12",
    ...
    },
    {
      ...
      description:
        "LGA1700 soket destekli ekonomik ve güçlü işlemci.",
      specs: {
        Soket: "LGA1700",
        Çekirdek: "10",
        "İş Parçacığı": "16",
  ...
  "ekran-karti": [
    {
      ...
      description:
        "1080p ve 1440p oyunlar için DLSS 3 destekli ekran kartı.",
      specs: {
        VRAM: "8GB",
        Mimari: "Ada Lovelace",
      },
    },
    {
      ...
      description:
        "Yüksek kare hızları ve 2K oyun deneyimi sunar.",
      specs: {
        VRAM: "12GB",
        Mimari: "Ada Lovelace",
      },
  ...
  anakart: [
    {
      ...
      description:
        "AM5 işlemciler için DDR5 destekli anakart.",
      specs: {
        Soket: "AM5",
        Tür: "DDR5",
        Boyut: "mATX",
    ...
    },
    {
      ...
      description:
        "LGA1700 soket ekonomik anakart çözümü.",
      specs: {
        Soket: "LGA1700",
        Tür: "DDR4",
        Boyut: "mATX",
  ...
  ram: [
    ...
    },
    {
      ...
      description:
        "DDR4 sistemler için kararlı bellek.",
      specs: {
        Tür: "DDR4",
        Kapasite: "16GB",
        Hız: "3200MHz",
  ...
  psu: [
    {
      ...
      description:
        "Güvenilir ve sertifikalı güç kaynağı.",
      specs: {
        Güç: "650W",
        Sertifika: "80+ Bronze",
      },
  ...
  ssd: [
    {
      ...
      description:
        "Yüksek okuma/yazma hızlarına sahip M.2 SSD.",
      specs: {
        Kapasite: "1TB",
        Okuma: "3500 MB/s",
      },
